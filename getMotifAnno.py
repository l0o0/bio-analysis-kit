#!/bin/env python
# 2014-12-17	Linxzh
# After analysys the motif enrichment, get the motif 
# description from PLACE(http://www.dna.affrc.go.jp/)
...
def get_description(accession):
	...
	htmltext = urllib2.urlopen(req, timeout=(random.randint(1,10))).read()
